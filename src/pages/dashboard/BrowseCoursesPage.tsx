...
import { fetchPublishedCourses } from '@/lib/courseRepository';
import {
...
export function BrowseCoursesPage() {
  ...
  const handleEnroll = (courseId: string) => {
    ...
    if (!alreadyEnrolled) {
      ...
      const nextEnrollments = [...existingEnrollments, nextEnrollment];
      ...
      {filteredCourses.length === 0 && (
        <div className="card flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="mt-2 max-w-md text-sm text-gray-500 dark:text-gray-400">
            Try adjusting the search or filters to discover more options.
          </p>
        </div>
      )}
